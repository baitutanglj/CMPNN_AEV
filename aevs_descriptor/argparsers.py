...
def trainparser(default="BP"):
    ...
    parser.add_argument(
        "-train", "--trainfile", type=str, default=None, help="train set file"
    )
    parser.add_argument(
...
def predictparser():
    ...
    parser.add_argument(
        "-test", "--testfile", type=str, default=None, help="test set file"
    )
    parser.add_argument("-e", "--aev", type=str, default="aevc.pth", help="AEVComputer Model path")
    parser.add_argument(
