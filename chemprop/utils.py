...
def save_checkpoint(path: str,
                    ...
                    args: Namespace = None,
                    atom_features_scaler: StandardScaler = None,
                    bond_features_scaler: StandardScaler = None):
    """
    ...
    state = {
        ...
        'atom_features_scaler': {
            'means': atom_features_scaler.means,
            'stds': atom_features_scaler.stds
        } if atom_features_scaler is not None else None,
        'bond_features_scaler': {
            'means': bond_features_scaler.means,
            'stds': bond_features_scaler.stds
        } if bond_features_scaler is not None else None
    }
...
def load_scalers(path: str) -> Tuple[StandardScaler, StandardScaler]:
    ...
    atom_features_scaler = StandardScaler(state['atom_features_scaler']['means'],
                                     state['atom_features_scaler']['stds'],
                                     replace_nan_token=0) if state['atom_features_scaler'] is not None else None
    bond_features_scaler = StandardScaler(state['bond_features_scaler']['means'],
                                     state['bond_features_scaler']['stds'],
                                     replace_nan_token=0) if state['bond_features_scaler'] is not None else None
    return scaler, features_scaler, atom_features_scaler, bond_features_scaler
