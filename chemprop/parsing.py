...
def add_predict_args(parser: ArgumentParser):
    ...
    #############my addition##################
    parser.add_argument(
        "-d", "--datapaths", type=str, default="", help="Path to pdbbing data")
    parser.add_argument('--smiles_columns', type=str, default='smiles',
    ...
    parser.add_argument('--target_columns', type=str,nargs='+', default=None,
                        help='Name of the columns containing target values.By default,'
                             ' uses all columns except the SMILES,protein,ligand columns')
    parser.add_argument('--ligand_file_type', type=str, default='smiles',
                        choices=['smiles', 'pdb', 'sdf', 'mol2'],
                        help='Type of ligand input,Default:smiles')
...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--target_columns', type=str,nargs='+', default=None,
                        help='Name of the columns containing target values.By default,'
                             ' uses all columns except the SMILES,protein,ligand columns')
    parser.add_argument('--preds_path', type=str, default=None, help='Predicted result path.')
    parser.add_argument('--separate_test_atom_descriptors_path', type=str,
                        help='Path to file with atom features for separate test set')
    parser.add_argument('--overwrite_default_atom_features', action='store_true', default=False,
                        help='concatenates the new features to the embedded atomic features')
    parser.add_argument('--overwrite_default_bond_features', action='store_true', default=False,
                        help='concatenates the new features to the embedded bond features')
    parser.add_argument('--ligand_file_type', type=str, default='smiles',
                        choices=['smiles', 'pdb', 'sdf', 'mol2'],
                        help='Type of ligand input,Default:smiles')
    parser.add_argument('--atom_descriptors_path', type=str, default=None,
    ...
    parser.add_argument('--atom_descriptor_scaling', action='store_true', default=False,
