...
# =============================================================================
    ...
    if args.separate_val_path:
        val_data = get_data(path=args.separate_val_path, args=args,
                            ...
                            atom_descriptors_path=args.separate_val_features_path, logger=logger)
    ...
    for model_idx in range(args.ensemble_size):
        ...
        for epoch in range(args.epochs):
            ...
            if epoch==args.epochs-1:
                save_checkpoint(os.path.join(save_dir, 'model_last.pt'), model, scaler, features_scaler, args)
